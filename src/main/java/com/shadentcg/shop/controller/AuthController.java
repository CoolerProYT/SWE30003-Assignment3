...
/**
 * Handles registration and login pages.
 * On registration, transfers GuestSession cart to the new account (A2: GuestSession.transferCartTo).
 */
@Controller
@RequestMapping("/auth")
public class AuthController {
    ...
    public String register(
        ...
        try {
            customerService.register(fullName, email, password, phone,
                                     street, suburb, state, postcode);

            // A2: Transfer GuestSession cart to the new customer's session cart

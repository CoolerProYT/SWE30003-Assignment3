...
public class DataSeeder implements CommandLineRunner {
    ...
    public DataSeeder(CustomerRepository customerRepository, ProductRepository productRepository, ProductCategoryRepository categoryRepository, PasswordEncoder passwordEncoder) {
    ...
    private void seedAdminAccount() {
        ...
        Customer admin = new Customer("Admin Staff", "admin@shaden.com", passwordEncoder.encode("admin123"), "03-9999-0001");
        admin.setRole("ROLE_ADMIN");
        admin.addDeliveryAddress(new DeliveryAddress("123 Shop Street", "Hawthorn", "VIC", "3122", "Australia"));
    ...
    private void seedSampleCustomer() {
        ...
        Customer customer = new Customer("Jane Smith", "customer@shaden.com", passwordEncoder.encode("customer123"), "0412-345-678");
        customer.addDeliveryAddress(new DeliveryAddress("45 Oak Avenue", "Richmond", "VIC", "3121", "Australia"));
    ...
    private void seedProducts() {
        ...
        for (Object[] p : products) {
            ...
            productRepository.save(new Product((String) p[0], (String) p[1], (BigDecimal) p[2], (Integer) p[3], cat));
        }
